...
//for FlyingTubus 1.0
//Author: Nicholas Rehm & Benjamin Kelm
...
const int m1Pin = 25; // Top Motor - BEN
const int m2Pin = 24; // Bottom Motor - BEN
const int m3Pin = 2;
const int m4Pin = 3;
const int m5Pin = 4;
const int m6Pin = 5;
//PWM servo or ESC outputs:
const int servo1Pin = 11; // Top Servo -  BEN
const int servo2Pin = 12; // Bottom Servo - BEN
...
void setup() {
  ...
  servo1.attach(servo1Pin, 1100, 1950); //Pin, min PWM value, max PWM value
  servo2.attach(servo2Pin, 1000, 1950);
...
void controlMixer() {
  ...
  //Quad mixing - EXAMPLE
  m1_command_scaled = thro_des + 0.2 * yaw_PID + 0.2 * yaw_passthru; //Top
  m2_command_scaled = 0.8 * (thro_des - 0.2 * yaw_PID + 0.2 * yaw_passthru); //Bottom
